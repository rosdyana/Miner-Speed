...
namespace MinerSpeed
{
    ...
    //********************************************************************************************************************************
    GameView::GameView()
        : View(), mBoardView(nullptr), mAudio(nullptr), mCurrentState(GameView::State::STATE_MIN), mTime(0.0f), mWelcomeTextPosition(0.0f, 0.0f), mGameOverTextPosition(0.0f, 0.0f), mPlayingTimeLabelPosition(0.0f, 0.0f), myTimerID(NULL)
    {
    }
